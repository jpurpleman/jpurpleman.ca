<?php get_header(); ?>
	<div id="content" class="container" itemprop="mainContentOfPage" itemscope="itemscope" itemtype="http://schema.org/Blog" role="main">
		<h1><?php printf( __( 'Results for: %s', 'rational-start' ), get_search_query() ); ?></h1>
<?php	if ( have_posts() ) {
?>			<div class="row">
				<div class="col-sm-8">
...
?>			</div>
<?php	} else {
?>			<p><?php _e( 'I couldn&rsquo;t find what you&rsquo;re looking for. Try searching again with different terms.', 'rational-start' ); ?></p>
<?php		get_search_form();
		}
?>	</div>
<?php get_footer(); ?>