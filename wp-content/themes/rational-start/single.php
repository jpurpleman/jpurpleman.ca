...
<?php					the_post_navigation( array(
							'prev_text' => '<i class="fa fa-chevron-left"></i> &nbsp;<span class="collapse-desktop">%title</span>',
							'next_text' => '<span class="collapse-desktop">%title</span>&nbsp; <i class="fa fa-chevron-right"></i>'
						) );
